# Generated by Django 5.2.6 on 2025-10-30 10:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Science', 'Science'), ('Fiction', 'Fiction'), ('Mathematics', 'Mathematics'), ('History', 'History'), ('DataScience', 'DataScience')], max_length=50)),
                ('description', models.TextField(blank=True, null=True)),
                ('publication_date', models.DateField(blank=True, null=True)),
                ('pages', models.IntegerField(blank=True, null=True)),
                ('language', models.CharField(choices=[('English', 'English'), ('Spanish', 'Spanish'), ('French', 'French'), ('German', 'German'), ('Other', 'Other')], default='English', max_length=50)),
